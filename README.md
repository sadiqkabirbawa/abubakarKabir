...
1. **Student Performance Analysis**
   ...
   * *([https://github.com/sadiqkabirbawa/student_performance_analysis])*
...
2. **Employee Workforce Analysis**
   ...
   * *([https://github.com/sadiqkabirbawa/Employee_workforce_analysis])*
...
3. **Online Retail Sales Analysis**
   ...
   * *Tech Stack:* Python + SQL + Statistics 
   * *([https://github.com/sadiqkabirbawa/Online_retail_sales_analysis])*
...
Payments: Paystack API integration
   * *([https://github.com/sadiqkabirbawa/Ausu-Mssn-Digital-Repository])*
---
